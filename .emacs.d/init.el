...
(custom-set-variables
 ...
 '(org-format-latex-options
   '(:scale 2 :foreground default :background default :html-foreground "Black" :html-background "Transparent" :html-scale 1.0 :matchers
            ("begin" "$1" "$" "$$" "\\(" "\\[")))
